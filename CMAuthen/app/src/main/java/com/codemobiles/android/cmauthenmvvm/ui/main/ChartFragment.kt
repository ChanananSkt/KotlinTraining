...
class ChartFragment : Fragment(R.layout.fragment_chart) {
            ...
            viewModel.dataSets.collect() {
                ...
                data.setValueFormatter(object : ValueFormatter() {
                    override fun getFormattedValue(value: Float): String {
                        ...
                        return "${mFormat.format(newValue)}%"
                    }
                })
    ...
    private fun drawChart() {
        ...
        // Optional: Customize your XAxis further (e.g., label rotation, text size)
        xAxis.labelRotationAngle = 45f
        xAxis.textSize = 12f
        xAxis.granularity = 1f // Specify the interval between labels
        xAxis.valueFormatter = object : ValueFormatter() {
            override fun getFormattedValue(value: Float): String {
                val index = value.toInt()
                return viewModel.priceArray[index].date
            }
        }
